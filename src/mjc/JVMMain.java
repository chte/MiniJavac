...
//Main class of the program
  ...
  Token t; Token main; Identifier id1, id2; VarDecl v; Statement stmt; VarDeclList vdl = new VarDeclList(); StatementList sl = new StatementList();
    ...
    t = jj_consume_token(IDENTIFIER);
                     id1 = new Identifier(t.image, t.endLine, t.endColumn);
    jj_consume_token(LBRACE);
    jj_consume_token(PUBLIC);
    jj_consume_token(STATIC);
    jj_consume_token(VOID);
    main = jj_consume_token(IDENTIFIER);
    jj_consume_token(LPAREN);
    jj_consume_token(STRING);
    jj_consume_token(LBRACKET);
    jj_consume_token(RBRACKET);
    t = jj_consume_token(IDENTIFIER);
                                                                                                              id2 = new Identifier(t.image, t.endLine, t.endColumn);
    ...
    {if (true) return new MainClass(id1, id2, vdl, sl, main.endLine, main.endColumn);}
    throw new Error("Missing return statement in function");
  }
...
//Class declaration with extends
  ...
  Token t; Identifier id, ide; VarDecl v; MethodDecl m; VarDeclList vl = new VarDeclList(); MethodDeclList ml = new MethodDeclList();
    jj_consume_token(CLASS);
    t = jj_consume_token(IDENTIFIER);
                            id=new Identifier(t.image, t.endLine, t.endColumn);
    jj_consume_token(EXTENDS);
    t = jj_consume_token(IDENTIFIER);
                                                                                                               ide = new Identifier(t.image, t.endLine, t.endColumn);
    jj_consume_token(LBRACE);
    label_4:
    while (true) {
      if (jj_2_3(2)) {
    ...
    jj_consume_token(RBRACE);
    {if (true) return new ClassDeclExtends(id, ide, vl, ml, t.endLine, t.endColumn);}
    throw new Error("Missing return statement in function");
  }
...
/* Class declaration */
  ...
  Token t; Identifier id, ide; VarDecl v; MethodDecl m; VarDeclList vl = new VarDeclList(); MethodDeclList ml = new MethodDeclList();
    ...
    jj_consume_token(RBRACE);
    {if (true) return new ClassDeclSimple(id, vl, ml, t.endLine, t.endColumn);}
    throw new Error("Missing return statement in function");
  }
...
//Method declaration
  ...
  Exp e; Token t; Type type; Identifier id;  VarDecl v; Statement s; FormalList fl = new FormalList(); VarDeclList vl = new VarDeclList(); StatementList sl = new StatementList();
    ...
    jj_consume_token(SEMICOLON);
    jj_consume_token(RBRACE);
    {if (true) return new MethodDecl(type, id, fl, vl, sl, e, t.endLine, t.endColumn);}
    throw new Error("Missing return statement in function");
  }

//Formal list - this is used as input in functions
  ...
  Token t; Type type; Identifier id; Formal f; FormalList fl = new FormalList();
    ...
    t = jj_consume_token(IDENTIFIER);
                               id=new Identifier(t.image, t.endLine, t.endColumn);
                                                                                       f = new Formal(type, id, t.endLine, t.endColumn); fl.addElement(f);
    label_10:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
...
//Formal list - for the recursion of the formal list
 ...
 */
  ...
  Token t; Type type;
    ...
    case IDENTIFIER:
      t = jj_consume_token(IDENTIFIER);
                       type=new IdentifierType(t.image, t.endLine, t.endColumn);
      break;
    default:
      jj_la1[10] = jj_gen;
      jj_consume_token(-1);
 ...
 */
  ...
  Token t; Exp e1, e2; Identifier id; Statement rs, s1, s2; VarDecl v; StatementList sl = new StatementList(); VarDeclList vl = new VarDeclList();
    ...
    case IF:
      ...
      jj_consume_token(RPAREN);
      s1 = Stmt();
                                                    rs = new If(e1, s1, t.endLine, t.endColumn);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ELSE:
        jj_consume_token(ELSE);
        s2 = Stmt();
                                        rs = new IfElse(e1, s1, s2, t.endLine, t.endColumn);
        break;
      default:
        jj_la1[12] = jj_gen;
        ;
    ...
    case WHILE:
      ...
      jj_consume_token(RPAREN);
      s1 = Stmt();
                                                       rs = new While(e1, s1, t.endLine, t.endColumn);
      break;
    case SYSOUT_PRINTLN:
    ...
    default:
      ...
      if (jj_2_9(2)) {
        ...
        e1 = Exp();
        jj_consume_token(SEMICOLON);
                                                                                                                      rs = new Assign(id, e1, t.endLine, t.endColumn);
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case IDENTIFIER:
          t = jj_consume_token(IDENTIFIER);
          ...
          e2 = Exp();
          jj_consume_token(SEMICOLON);
                                                                                                                                                    rs = new ArrayAssign(id,e1,e2, t.endLine, t.endColumn);
          break;
        default:
          jj_la1[14] = jj_gen;
          jj_consume_token(-1);
 ...
 */
  ...
  Token t; Exp e2, re;
    ...
    e2 = AndExp();
                              re = new Or(e1, e2, t.endLine, t.endColumn);
    if (jj_2_11(2)) {
      re = ExpPrim(re);
    } else {
      ;
 ...
 *
 */
  static final public Exp AndExpPrim(Exp e1) throws ParseException {
  Token t; Exp e2, re;
    re = e1;
    t = jj_consume_token(SC_AND);
    e2 = EqExp();
                                 re = new And(e1, e2, t.endLine, t.endColumn);
    if (jj_2_13(2)) {
      re = AndExpPrim(re);
    } else {
      ;
 ...
 *
 */
  static final public Exp EqExp() throws ParseException {
  Token t; Exp e1, e2, re;
    e1 = RelExp();
    if (jj_2_14(2)) {
      e1 = EqExpPrim(e1);
 ...
 *
 */
  static final public Exp EqExpPrim(Exp e1) throws ParseException {
  Token t; Exp e2, re;
    re = e1;
    if (jj_2_15(2)) {
      t = jj_consume_token(EQ);
      e2 = RelExp();
                              re = new Equal(e1, e2, t.endLine, t.endColumn);
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case NE:
        t = jj_consume_token(NE);
        e2 = RelExp();
                              re = new NotEqual(e1, e2, t.endLine, t.endColumn);
        break;
      default:
        jj_la1[15] = jj_gen;
        jj_consume_token(-1);
 ...
 *
 */
  static final public Exp RelExpPrim(Exp e1) throws ParseException {
  Token t; Exp e2, re;
    re = e1;
    if (jj_2_18(2)) {
      t = jj_consume_token(LT);
      e2 = AddExp();
                             re = new LessThan(e1, e2, t.endLine, t.endColumn);
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LE:
        t = jj_consume_token(LE);
        e2 = AddExp();
                             re = new LessThanOrEqual(e1, e2, t.endLine, t.endColumn);
        break;
      case GT:
        t = jj_consume_token(GT);
        e2 = AddExp();
                             re = new GreaterThan(e1, e2, t.endLine, t.endColumn);
        break;
      case GE:
        t = jj_consume_token(GE);
        e2 = AddExp();
                             re = new GreaterThanOrEqual(e1, e2, t.endLine, t.endColumn);
        break;
      default:
        jj_la1[16] = jj_gen;
        jj_consume_token(-1);
 ...
 *
 */
  static final public Exp AddExpPrim(Exp e1) throws ParseException {
  Token t; Exp e2, re;
    re = e1;
    if (jj_2_21(2)) {
      t = jj_consume_token(MINUS);
      e2 = MultExp();
                                 re = new Minus(e1, e2, t.endLine, t.endColumn);
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case PLUS:
        t = jj_consume_token(PLUS);
        e2 = MultExp();
                                re = new Plus(e1, e2, t.endLine, t.endColumn);
        break;
      default:
        jj_la1[17] = jj_gen;
        jj_consume_token(-1);
 ...
 *
 */
  static final public Exp MultExpPrim(Exp e1) throws ParseException {
  Token t; Exp e2, re;
    re = e1;
    t = jj_consume_token(STAR);
    e2 = PrimaryExp();
                                   re = new Times(e1, e2, t.endLine, t.endColumn);
    if (jj_2_24(2)) {
      re = MultExpPrim(re);
    } else {
      ;
  ...
  Token t; Exp e;
    ...
    case INTEGER_LITERAL:
      t = jj_consume_token(INTEGER_LITERAL);
                               e = new IntegerLiteral(Integer.parseInt(t.image), t.endLine, t.endColumn);
      break;
    case LONG_LITERAL:
      t = jj_consume_token(LONG_LITERAL);
                            e = new LongLiteral(Long.parseLong(t.image.substring(0, t.image.length()-1)), t.endLine, t.endColumn);
      break;
    case TRUE:
    ...
    case IDENTIFIER:
      t = jj_consume_token(IDENTIFIER);
                          e = new IdentifierExp(t.image, t.endLine, t.endColumn);
      break;
    case THIS:
    ...
    default:
      ...
      if (jj_2_27(2)) {
        if (jj_2_25(2147483647)) {
          ...
          jj_consume_token(LBRACKET);
          e = Exp();
                                                 e = new NewIntArray(e, t.endLine, t.endColumn);
          jj_consume_token(RBRACKET);
                                                                                                                  {if (true) return e;}
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        ...
        if (jj_2_26(2147483647)) {
          ...
          jj_consume_token(LBRACKET);
          e = Exp();
                                                  e = new NewLongArray(e, t.endLine, t.endColumn);
          jj_consume_token(RBRACKET);
                                                                                                                    {if (true) return e;}
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        ...
        case NEW:
       Token obj;
          obj = jj_consume_token(NEW);
          t = jj_consume_token(IDENTIFIER);
                                                  e = new NewObject(new Identifier(t.image, t.endLine, t.endColumn), obj.endLine, obj.endColumn);
          jj_consume_token(LPAREN);
          jj_consume_token(RPAREN);
          break;
        case NOT:
          ...
          e = PrimaryExp();
                                   e = new Not(e, t.endLine, t.endColumn);
          break;
        case LPAREN:
          jj_consume_token(LPAREN);
          e = Exp();
 ...
 *
 */
  static final public Exp PrimaryExpPrim(Exp e1) throws ParseException {
  Token t; Exp e2; Identifier id; ExpList el;
    ...
    case LBRACKET:
      ...
      e2 = Exp();
      jj_consume_token(RBRACKET);
                                     {if (true) return new ArrayLookup(e1, e2, t.endLine, t.endColumn);}
      break;
    default:
      jj_la1[22] = jj_gen;
      if (jj_2_30(2)) {
        ...
        jj_consume_token(LENGTH);
                       {if (true) return new ArrayLength(e1, t.endLine, t.endColumn);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case DOT:
     Token call;
          call = jj_consume_token(DOT);
          t = jj_consume_token(IDENTIFIER);
                                                 id = new Identifier(t.image, t.endLine, t.endColumn);
          jj_consume_token(LPAREN);
          el = ExpList();
          jj_consume_token(RPAREN);
                                                                                                                                            {if (true) return new Call(e1, id, el, call.endLine, call.endColumn);}
          break;
        default:
          jj_la1[23] = jj_gen;
          jj_consume_token(-1);
 ...
 */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4,0x4,0x488020,0x200,0x200,0xc2,0x488020,0x8000000,0x40,0x80,0xc2,0x488020,0x8,0x488020,0x0,0x0,0x0,0x0,0x100,0x100,0xc0003010,0x20100100,0x1000000,0x10000000,0x8000000,0xe0103110,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x1,0x0,0x0,0x1,0x1,0x0,0x0,0x0,0x1,0x1,0x0,0x0,0x1,0x80,0x68,0x400,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x1,};
   }
