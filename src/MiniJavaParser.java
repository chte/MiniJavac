 ...
 */
  ...
  Exp e;
      ...
      default:
        ...
        if (jj_2_7(2)) {
          ...
          jj_consume_token(NEW);
          t = jj_consume_token(IDENTIFIER);
                                 e = new NewObject(new IdentifierExp(t.image));
          jj_consume_token(LPAREN);
          jj_consume_token(RPAREN);
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80,0x21100400,0x4000,0x21100400,0x0,0x840,0x840,0x0,0x21100400,0x21100400,0x2060200,0x8000000,0x80000000,0x0,0xa062200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x20,0x0,0x20,0x4,0x20,0x20,0x3e00,0x20,0x20,0x20,0x10,0x0,0x4,0x30,};
   }
